...
#ifndef _kinect_link_msg_t_h
#define _kinect_link_msg_t_h
...
#include "lcmtypes/kinect_point3d_t.h"
typedef struct _kinect_link_msg_t kinect_link_msg_t;
struct _kinect_link_msg_t
{
    int32_t    joint_id;
    kinect_point3d_t source;
    kinect_point3d_t dest;
};

/**
 * Create a deep copy of a kinect_link_msg_t.
 * When no longer needed, destroy it with kinect_link_msg_t_destroy()
 */
kinect_link_msg_t* kinect_link_msg_t_copy(const kinect_link_msg_t* to_copy);

/**
 * Destroy an instance of kinect_link_msg_t created by kinect_link_msg_t_copy()
 */
void kinect_link_msg_t_destroy(kinect_link_msg_t* to_destroy);

/**
 * Identifies a single subscription.  This is an opaque data type.
 */
typedef struct _kinect_link_msg_t_subscription_t kinect_link_msg_t_subscription_t;

/**
 * Prototype for a callback function invoked when a message of type
 * kinect_link_msg_t is received.
 */
typedef void(*kinect_link_msg_t_handler_t)(const lcm_recv_buf_t *rbuf,
             const char *channel, const kinect_link_msg_t *msg, void *userdata);

/**
 * Publish a message of type kinect_link_msg_t using LCM.
 *
 ...
 */
int kinect_link_msg_t_publish(lcm_t *lcm, const char *channel, const kinect_link_msg_t *msg);

/**
 * Subscribe to messages of type kinect_link_msg_t using LCM.
 *
 ...
 */
kinect_link_msg_t_subscription_t* kinect_link_msg_t_subscribe(lcm_t *lcm, const char *channel, kinect_link_msg_t_handler_t handler, void *userdata);

/**
 * Removes and destroys a subscription created by kinect_link_msg_t_subscribe()
 */
...
/**
 * Encode a message of type kinect_link_msg_t into binary form.
 *
 * @param buf The output buffer.
 * @param offset Encoding starts at this byte offset into @p buf.
 * @param maxlen Maximum number of bytes to write.  This should generally
 *               be equal to kinect_link_msg_t_encoded_size().
...
/**
 * Decode a message of type kinect_link_msg_t from binary form.
 * When decoding messages containing strings or variable-length arrays, this
 * function may allocate memory.  When finished with the decoded message,
 * release allocated resources with kinect_link_msg_t_decode_cleanup().
 *
 ...
 */
int kinect_link_msg_t_decode(const void *buf, int offset, int maxlen, kinect_link_msg_t *msg);

/**
 * Release resources allocated by kinect_link_msg_t_decode()
 * @return 0
 */
int kinect_link_msg_t_decode_cleanup(kinect_link_msg_t *p);

/**
 * Check how many bytes are required to encode a message of type kinect_link_msg_t
 */
